            ...
            >
                <van-tab title="消息">
                    <MessageList State="1" :config="[
                        {id: '1', text:'待派工', img: require('../../assets/img/dpg.png'), color: '#FF9E48'},
                        {id: '3', text:'待验收', img: require('../../assets/img/dys.png'), color: '#48A4FF'},
                        {id: '6', text:'待接单', img: require('../../assets/img/djd.png'), color: '#48A4FF'},
                        {id: '8', text:'待审批', img: require('../../assets/img/dsp.png'), color: '#48A4FF'}
                    ]"/>
                </van-tab>
                <van-tab title="待处理">
