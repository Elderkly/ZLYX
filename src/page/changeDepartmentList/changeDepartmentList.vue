<template>
    <Box title="资产转科">
        ...
        >
            ...
            <div class="listItems items" v-for="item in list" @click="$router.push({name: 'PropertyDetails', params: {item} })">
                <div>
                    <img :src="item.Img"/>
                    <div>
                    ...
                    <div>
                        ...
                        <div @click.stop="$router.push({name: 'ChangeDepartment', params: {item}})">申请转科</div>
                    </div>
                </div>
                <div>
                    <span>启用日期</span>
