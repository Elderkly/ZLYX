    ...
    <div class="Pending">
        <Box title="维修处理">
            ...
            <div class="infoBox info">
                ...
                <Field title="维修厂家" :text="JC[0].RepairFactory" @onMessage="value => JC[0].RepairFactory = value"/>
                <Field title="维修类型" :text="JC[0].RepairMarkName" type='popup' :data="['自修', '第三方维修','原厂','报修']" @onMessage="value => JC[0].RepairMarkName = value"/>
            </div>
